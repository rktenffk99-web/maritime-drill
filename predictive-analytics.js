...
(function(global){
  ...
  function saveProfile(rows){
    ...
    rows.forEach(r=>{current.topics[r.key]={subject:r.subject,topic:r.label,total:r.total,attempts:r.attempts,wrong:r.wrong,unanswered:r.unanswered,errorRate:r.errorRate,reviewRate:r.reviewRate,targetShare:r.targetShare}});
